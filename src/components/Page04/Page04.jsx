  ...
  return (
    <>
      ...
      <div className='background__container'>
        <img
          src={process.env.PUBLIC_URL + `/images/tlo_linie.webp`}
          alt=''
        ...
        <h1 className='green'>
          2018 WYTYCZNE EVF
          <p className='copy'>
            Leki flebotropowe - poziom dowodów naukowych, wpływ na poszczególne
            objawy
          </p>
        </h1>
        <div className='table page04'>
          ...
          <section className='dark__greyPage02'>
            MPFF (ZMIKRONIZOWANA OCZYSZCZONA FRAKCJA FLAWONOIDOWA)
          </section>
          <section className='dark__greyPage02'>Okserutyna</section>
          <section className='dark__greyPage02'>
            Wyciąg z nasion kasztanowca (escyna)
          </section>
          <section id='dark__grey' className='dark__greyPage02'>
            Dobesylan wapnia
          </section>
          ...
          <div className='grey_page02 first '>Uczucie zmęczenia nóg </div>
          ...
          <div className='grey_page02 first darker'>Obwód wokół kostki</div>
          <div className='orange lighter next'>a</div>
          <div className='grey_page02 darker'>b</div>
          ...
          <div className='grey_page02 first '>Objętość kończyny</div>
          <div className='orange lighter next'>a</div>
          <div className='grey_page02 '>ns</div>
          <div className='grey_page02 '>ns</div>
          <div className='grey_page02 '>a</div>
          ...
          <div className='grey_page02 darker last  corner__left'>
            Jakość życia
          </div>
        ...
        <div className='przypisy'>
          <p style={{ fontSize: '9px' }} className='podpis'>
            NS - brak znamienności; A – dane pochodzące z wielu badań z
            randomizacją i metaanaliz. Dowody na poziomie A sugerują, że kolejne
            badania z dużym prawdopodobieństwem nie zmienią naszej pewności co
            do efektu działania leku; B – dane pochodzące z pojedynczego dobrego
            badania z randomizacją lub więcej niż jednego badania z
            randomizacją, ale z mniej spójnymi wynikami lub problemami
            metodologicznymi, które mają bezpośrednie zastosowanie do populacji
            docelowej, jak również badanie ekstrapolowane na populację docelową
            z innej grupy pacjentów. Dowody na poziomie B sugerują, że dalsze
            badania mogą mieć istotny wpływ na zaufanie i ocenę efektu i mogą
            wpłynąć na zmianę opinii; C – dowody wynikają ze źle
            zaprojektowanych badań, badań obserwacyjnych lub małych serii
            przypadków. Dowody na poziomie C sugerują, że dalsze badania z dużym
            prawdopodobieństwem będą miały istotny wpływ na zaufanie i ocenę
            efektu i prawdopodobnie wpłyną na zmianę opinii.
          </p>
          <p className='przypis'>
            Źródło: Na podst.: Nicolaides AN, et al.: Venoactive drugs.
