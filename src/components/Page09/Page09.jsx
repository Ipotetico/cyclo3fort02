      ...
      <div className='page__container'>
        ...
        <section className='grades__container page09'>
          <div className='container__up'>
            <img
              onClick={() => setPage(10)}
              src={process.env.PUBLIC_URL + `/images/unikalne.png`}
              alt=''
            />
            <div
              style={{
            ...
            >
              <h1>
                ...
                w komórkach mięśni gładkich naczyń limfatycznych*{' '}
              </h1>
            </div>
            <img
              style={{ alignSelf: 'center', justifySelf: 'center' }}
              src={process.env.PUBLIC_URL + `/images/mala_strzala.svg`}
              alt=''
            />
            <div
              style={{
