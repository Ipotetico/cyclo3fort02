  ...
  return (
    <>
      ...
      <div className='background__container'>
        ...
        <div onClick={() => setPage(4)} className='table page05'>
        ...
        <div className='przypisy'>
          <p className='podpis'>
            A – dane pochodzące z wielu badań z randomizacją i metaanaliz.
            Dowody na poziomie A sugerują, że kolejne badania z dużym
            prawdopodobieństwem nie zmienią naszej pewności co do efektu
            działania leku;
          </p>
          <p className='przypis'>
